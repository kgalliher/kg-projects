...
@params:
    ...
    layerTable = fully qualified sde layers table name.  fully qualified to catch DBO/SDE schema and PG/SQL vs Oracle name differences.
    fcName = name of the feature class to describe.
